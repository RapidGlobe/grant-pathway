...
| ~~`docs/target-funder-list.md`~~ — **ARCHIVED 2026-08-19** | Moved to `docs/archive/`. Its premise — that funder identity predicts behaviour — was superseded by `DR-FD-001` v1.4 (picker and directory removed) and `DR-TEST-001` (test plans organised by guideline shape). **Use `docs/Test Plans/TEST-DASHBOARD.md` for coverage. Do not add funders to the archived list.**                                                                                                                                   |
