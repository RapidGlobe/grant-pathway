...
**Update (2026-07-14) — Phase 5 (P6.6, Transparency Status) retired, will not be built.** Its basis (a support-status signal derived from an approved, curator-reviewed playbook) disappeared when Phase 4 (P6.5) was rebuilt as private, per-charity reuse with no curator role — every funder is now in the identical, never-reviewed state, so there is nothing left for a trust-tier badge to differentiate. The gate above now requires P6.1–P6.5, not P6.1–P6.6. See `ADR-DATA-006`'s 2026-07-14 (later same day) amendment.
