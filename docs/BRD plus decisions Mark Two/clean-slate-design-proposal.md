...
| Export (Step 5)              | One fixed generic Word template, identical for every funder (`app/api/export/[applicationId]/route.ts`)                                                                                                                                       | Same generic export, plus funder-native document filling (Stony Stratford-style)                       | Generic export: **keep as-is**. Native filling: **new capability from zero**        |
...
| Charity profile              | Already reasonably rich — identity, contact, mission, financials, document status (`docs/data-model.md`)                                                                                                                                      | Add governance facts and a couple of derived ratios                                                    | **Small, additive** — not a rebuild                                                 |
