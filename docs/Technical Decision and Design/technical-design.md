...
- If the modal is dismissed via "Sign out now," or ignored until the 60-minute mark, the user is signed out and redirected to `/` with the message: _"You've been signed out due to inactivity."_
