...
**Option C ("never store") is reversed.** This section supersedes the Decision, Rationale, and Consequences above; the original text is kept intact above for the historical record rather than rewritten.
