...
| Date       | Change                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| ---------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| 2026-08-09 | **The automated half of Option C's mechanism changed: `axe-core` is now driven directly, not through `@axe-core/react`.** Found (`DEF-04`, `accessibility-test-plan.md`) that `@axe-core/react`'s own React-integration glue depends on mutable module exports that React 19 makes read-only, so it had silently failed to report any violation since the project adopted React 19 — the Decision's "`axe-core` (via `@axe-core/react` in development...) runs on every development build" had not been true in practice. Fixed (`GAP-54`) by dropping the incompatible integration layer rather than patching it: `components/axe-provider.tsx` imports `axe-core` directly — the engine underneath `@axe-core/react`, with no such dependency — and runs it itself on mount and on a debounced `MutationObserver` over `document.body`. The Decision's substance is unchanged (`axe-core` still runs on every development build and surfaces violations in the browser); only the vehicle named in the Consequences bullet ("`@axe-core/react` should be added as a dev dependency") is superseded — `package.json` now depends on `axe-core` directly instead. |
