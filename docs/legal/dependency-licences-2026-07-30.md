...
| --------------------------------------------- | ------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `axe-core`                                    | MPL-2.0 | Accessibility testing. Runs only when `NODE_ENV === 'development'` — the same fact that blocked HT-05's axe step against the deployed site on 2026-07-25. Was `axe-core`, `@axe-core/react` at review time; the latter was dropped 2026-08-09 (`GAP-54`) for a React 19 incompatibility (`DEF-04`) — `axe-core` alone is now driven directly, no licence change |
