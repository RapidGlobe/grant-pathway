...
- Unsupported format: _"We can only accept PDF or Word (.docx) files. Please convert your document or paste the text directly."_
- File too large: _"Your file is over 10MB. Please upload a smaller file or paste the text directly."_
- Scanned/image PDF (unparseable): _"We couldn't read the text in your PDF — it may be a scanned document. Please try copying and pasting the text directly instead."_
