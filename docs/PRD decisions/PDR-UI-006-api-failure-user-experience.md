...
- Inline plain-language message: _"We couldn't reach the Charity Commission right now. Please try again in a few moments, or enter your charity details manually."_
- **Try again** button
...
- Inline plain-language message replaces the loading spinner: _"We couldn't generate your content right now. This is usually temporary — please try again."_
- **Try again** button
- All uploaded guidelines and previously saved content are preserved — no data is lost on failure
- If the error persists after retry: _"If this keeps happening, please try again later. Your work has been saved."_
