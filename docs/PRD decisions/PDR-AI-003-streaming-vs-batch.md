...
- **Option C — Batch with a progress indicator:** Full batch response with meaningful staged progress messages rather than a plain spinner (e.g. _"Reading your funder guidelines…"_ → _"Generating your draft…"_). Simple, safe, and provides reassurance during the wait.
...
- Summarisation: _"Reading your funder guidelines…"_ → _"Almost there…"_ → content appears
- Draft generation: _"Reviewing your guidelines and charity profile…"_ → _"Writing your draft answers…"_ → _"Almost there…"_ → content appears
