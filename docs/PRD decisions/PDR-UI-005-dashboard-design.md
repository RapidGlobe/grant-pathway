...
- Welcome message: *"Welcome to Grant Pathway, [name]"*
...
- Brief three-step explainer: *Add funder guidelines → Get an AI summary → Generate your draft*
...
- Application cards, each displaying:
  ...
  - Current status (e.g. *Draft in progress*, *Approved*, *Exported*)
  - Date last updated
