...
| [PDR-UI-009](PDR-UI-009-breached-password-rejection-message.md)      | What do we tell a user whose password was rejected for appearing in a data breach?                                                | Give the breach cause its own message; keep the rule message for length and character failures. `GAP-106`, decided 2026-08-17 |
