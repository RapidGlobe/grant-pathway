...
*Status: Complete*
*Sources: app-name-and-branding.md (BR-04), screen-requirements.md, user-personas-journeys-and-use-cases.md, PDR-UI-006, design decision records DDR-CS-005, DDR-IP-001, DDR-IP-002*
