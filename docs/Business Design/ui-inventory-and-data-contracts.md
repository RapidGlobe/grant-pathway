...
Auto-save behaviour applies across all steps: progress is saved on Continue, on field blur, and every 60 seconds in the background. **Amended 2026-08-06 (`GAP-44`):** background saves are no longer silent — every successful save is visibly confirmed to the user, unobtrusively and without stealing focus (`AC-FR-18-05`). Built 2026-08-06.
