...
The Warm & Approachable direction is built for users who are new to AI tools, working under time pressure, and doing important work for their communities. Every visual choice reinforces the message: *you are in the right place, and this is easy to use*.
...
*Status: Complete*
*Design direction: Warm & Approachable (DDR-VD-001 — Mockup 2)*
*Colour palette: Teal & Amber (BR-02)*
*Sources: DDR-VI-001, DDR-VI-002, DDR-LA-001, DDR-LA-002, DDR-VD-001, DDR-CS-001–006, DDR-IP-001–002, DDR-AC-001, app-name-and-branding.md (BR-02, BR-03), information-architecture-and-navigation.md, tone-and-voice-guide.md, non-functional-requirements.md*
