...
> **Change from v1.0 (22 May 2026):** "Data, Privacy, and Trust" section updated to reflect that operational backup infrastructure is now in place (ADR-DATA-005), and that AI processing takes place via Amazon Bedrock (UK/EEA) rather than Anthropic's direct API — correcting the data residency statement.
...
She finds the language confusing. Terms like "theory of change", "additionality", and "outcomes framework" were not designed for someone who simply wants to help people in her community. She refers back to old applications, copies what she can, rewrites the rest, and submits something she is never quite sure about. Two to three days of her life, every time.
...
The running costs of Grant Pathway are absorbed personally by the developer during the initial period. The longer-term plan is to establish a Community Interest Company — a social enterprise with a legal commitment to public benefit — and seek operational funding from organisations in the charity sector infrastructure, such as technology funders and digital inclusion programmes. That funding will sustain the free service for everyone who needs it.
...
All data is stored in UK-based infrastructure. AI processing takes place within the United Kingdom and European Economic Area — the funder guidelines and charity profile used to generate AI responses are processed within UK servers and never leave the EEA under any circumstances. The charity's information is used only to provide the service — to personalise the AI outputs and save time on future applications. It is never used to train artificial intelligence models. It is never shared with third parties for commercial purposes.

We maintain automated daily backups of the production database through our infrastructure provider. This is an operational safeguard — ensuring that data can be recovered in the event of a technical failure, security incident, or provider outage. It is not a mechanism for users to restore previously deleted data; deletions remain immediate and permanent from the user's perspective.

Users can delete their account and all associated data at any time, completely and permanently. Deletion removes all data from our live systems immediately; automated backup copies are permanently removed within seven days as part of the standard backup rotation cycle. Accounts that have not been used for two years are automatically deleted, with a warning email sent 30 days in advance. This is a deliberate data minimisation commitment — the service does not retain information beyond what is needed, and users are given fair notice before anything is removed.

The Privacy Policy and Terms of Service set all of this out clearly, in plain English, before anyone is asked to register.
