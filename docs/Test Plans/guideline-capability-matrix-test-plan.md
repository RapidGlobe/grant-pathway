...
**Not fixed** — WJ instructed on 2026-08-06 that both defects be logged without a code change, pending further review of the same application. This case stays **Fail** until they are.
