...
**Version:** 2.5
**Date:** 2026-08-14
**Status:** ✅ **Re-run against the June 2026 edition complete — MKCF-01–09 all Pass; `GAP-90` (MKCF-06's caveat) since fixed and live-verified.** `GAP-91` (MKCF-08's caveat) remains open, per WJ, pending a decision on whether it needs a code fix at all. This re-run is now current evidence the app handles `MK Comm Found oak-grants-criteria-final-june-2026.pdf` correctly, superseding the 2026-08-10 "not yet re-verified" status. See Document History.
