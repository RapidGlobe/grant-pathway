...
**Enhancement (not a defect):** WJ suggested displaying the 20% match requirement in bold/larger font given it's a hard eligibility condition. Recommend scoping this as a general pattern for all funder-specific "hard conditions" (match %, hard deadlines, exclusions) rather than an MKCF-only tweak — worth a DDR before implementing. **Recurrence confirmed 2026-07-04:** the same issue was independently found on Clothworkers' IT-CW-05 (£2 million income eligibility threshold, no visual distinction) — see that plan for detail. Two funders now show the same pattern; treat as one enhancement, not two.
...
| 1.5     | 2026-07-04 | Rapidglobe Ltd | Cross-referenced the IT-MKCF-07 "hard conditions" enhancement note against the same pattern independently found on Clothworkers' IT-CW-05 (income eligibility threshold, no visual distinction) -- confirmed as one recurring enhancement across two funders, not two separate issues.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
