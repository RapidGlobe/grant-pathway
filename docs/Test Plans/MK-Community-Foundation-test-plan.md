...
**Version:** 2.3
**Date:** 2026-08-10
**Status:** ⚠️ Guidelines refreshed to the June 2026 edition (2026-08-10, ahead of a live demo). The 2026-07-27 Pass results below (MKCF-01–09, 19 questions upload path / 16 paste path) were measured against the now-archived November 2025 file and are **not yet re-verified** against the new one. Re-run MKCF-01–09 against `MK Comm Found oak-grants-criteria-final-june-2026.pdf` before relying on this flagship as evidence the app handles the current guidelines. See Document History.
**Tester:** WJ
...
⚠️ **This is a newer edition than the results recorded below.** WJ downloaded the current Oak/Seed/Sapling criteria from the MKCF website on 2026-08-10, superseding the November 2025 edition this plan was last executed against (MKCF-01–09, 2026-07-27: 19 questions upload path, 16 paste path). The old file was not overwritten — per this section's own instruction, it has been preserved at `docs/Grant Org Guidelines/archive/MK Comm oak-grants-criteria-final-nov-2025.pdf` for historical comparison only. **Treat every result recorded below as unverified against the June 2026 edition until MKCF-01–09 is re-run.** Question counts, match-funding wording, or anything else extracted from the criteria may have changed since the last run — do not assume they still hold.
