...
| Lloyds Bank Foundation | [Lloyds-Bank-Foundation-test-plan.md](Lloyds-Bank-Foundation-test-plan.md) | 3 | — | 🟡 | Testing in progress. IT-LBF-01–03 passed. Harry's Rainbow mismatch account complete — DOCX upload confirmed, FR-47 eligibility hard stop working (Ineligible badge on dashboard). Moving to New Leaf happy path. |
