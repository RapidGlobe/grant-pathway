...
| Henry Smith Foundation | [Henry-Smith-Proud-Homes-test-plan.md](Henry-Smith-Proud-Homes-test-plan.md) | — | — | 🟡 | Test plan created. Programme: Proud Homes Fund (LGBT+ homelessness, young people 16–25). Test charity: Rainbow Steps MK (fictional). Key tests: AI policy banner, exact 300-word limit extraction. Ready to execute. |
