...
**Version:** 2.2
**Date:** 2026-08-06
**Status:** Under `DR-TEST-001` (capability-based test strategy). HT-01 to HT-04 Pass; HT-05 Blocked on its screen-reader step, which now runs as `accessibility-test-plan.md` AC-08. **HT-06 added 2026-08-06 and is now runnable but not yet executed** — `GAP-45`'s contextual help deep-links were built later the same day. All 8 targets were fetched and confirmed live during the build, but nobody has clicked the button in a browser yet.
**Tester:** WJ
...
| HT-06   | Contextual help deep-links — every screen opens the right page        | Not yet run | `GAP-45` built 2026-08-06; all 8 targets fetched and confirmed to resolve during the build. Needs WJ to click through — the author cannot sign in |
...
**Result:** ☐ Pass &nbsp;&nbsp; ☐ Fail &nbsp;&nbsp; ☐ Blocked &nbsp;&nbsp; ☒ **Not yet executed**
