...
**Version:** 2.3
**Date:** 2026-08-12
**Status:** Under `DR-TEST-001` (capability-based test strategy). HT-01 through HT-05 now all Pass — HT-05's screen-reader step ran live as `accessibility-test-plan.md` AC-08 and passed (`GAP-80`–`GAP-82` found and fixed). **HT-06 added 2026-08-06 and is now runnable but not yet executed** — `GAP-45`'s contextual help deep-links were built later the same day. All 8 targets were fetched and confirmed live during the build, but nobody has clicked the button in a browser yet.
**Tester:** WJ
