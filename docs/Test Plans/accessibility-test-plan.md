...
**Version:** 1.11
**Date:** 2026-08-09
**Status:** In execution. This is P5.3's output artefact and its definition of done. **AC-01 is now fully swept across two runs (rows 1–20 on 2026-08-05, the remaining rows on 2026-08-09) and has FAILED with five defects, four now fixed (`DEF-01`, `DEF-02`, `DEF-03`/`GAP-49`, `DEF-05`) and one open (`DEF-04`, the broken axe harness, feeding `GAP-15`).** AC-02 onward have not started. **Read AC-01 from the top — it assumes no prior experience of browser developer tools.**
**Tester:** WJ
...
| ------- | ---------------------------------------------- | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AC-01   | axe-core clean sweep, all routes               | ❌ Fail | **Fully swept across two runs** (rows 1–20 on 2026-08-05, remaining rows on 2026-08-09). 5 defects, 4 fixed: `DEF-01` contrast (fixed), `DEF-02` target-size (fixed), **`DEF-03` `scrollable-region-focusable` — WCAG 2.1.1 Level A, `GAP-49`** (fixed 2026-08-09), `DEF-04` broken axe auto-reporting (open, feeds `GAP-15`), `DEF-05` contrast on the "Answer approved" text (fixed 2026-08-09) |
