...
**Still to sweep in run 2:** rows 10 (note only), **11c and 11d**, 18's citation pop-up, 19, 20.2, 20.3, 20.5, 21, 22, 23/24, plus the two manual checks above.
...
**The coverage is partial and the case stays open.** Rows 10, 11c, 11d, 18's citation pop-up, 19, 20.2, 20.3, 20.5, 21, 22, 23 and 24 are unswept, and two `incomplete` findings need a human verdict. Do not read this Fail as the final answer — run 2 can only add findings, not remove them.
