...
**Version:** 1.12
**Date:** 2026-08-09
**Status:** In execution. This is P5.3's output artefact and its definition of done. **AC-01 is now fully swept across two runs (rows 1–20 on 2026-08-05, the remaining rows on 2026-08-09) and has FAILED with five defects, all five now fixed** (`DEF-01`, `DEF-02`, `DEF-03`/`GAP-49`, `DEF-04`/`GAP-54`, `DEF-05`). **A re-sweep to confirm zero regressions has not yet been run — see AC-01's note.** AC-02 onward have not started. **Read AC-01 from the top — it assumes no prior experience of browser developer tools.**
**Tester:** WJ
...
| ------- | ---------------------------------------------- | ------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| AC-01   | axe-core clean sweep, all routes               | ❌ Fail | **Fully swept across two runs** (rows 1–20 on 2026-08-05, remaining rows on 2026-08-09). 5 defects, **all 5 now fixed**: `DEF-01` contrast (fixed), `DEF-02` target-size (fixed), **`DEF-03` `scrollable-region-focusable` — WCAG 2.1.1 Level A, `GAP-49`** (fixed 2026-08-09), `DEF-04` broken axe auto-reporting (fixed 2026-08-09, `GAP-54` — driven off raw `axe-core` instead of `@axe-core/react`), `DEF-05` contrast on the "Answer approved" text (fixed 2026-08-09). **Stays ❌ Fail until a clean re-sweep confirms no regressions and reports 0 problems.** |
