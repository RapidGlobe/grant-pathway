...
**Version:** 2.12
**Date:** 2026-06-15
**Last updated:** 2026-08-06 (RT-09 and RT-10 gained an explicit multi-line fidelity check after `GAP-41`/D-015 — see Document History v2.12)
**Status:** RT-00 through RT-15 all Pass (RT-03, RT-09 and RT-11 with a caveat). ⚠️ **RT-09's caveat is the one that matters:** it passed on 2026-07-28 over a live defect — the Word export discards every line break in an answer (`GAP-41`, Defect Log D-015), found 2026-08-06 in a real user's downloaded document, not by this plan. RT-09 must be re-run with a genuinely multi-line answer once that is fixed. RT-03 and RT-11's caveats are stale plan text, corrected; RT-14 confirms the 2026-07-23 `service_role` grant fix holds on `grant-pathway-dev`, `grant-pathway-prod` still unpatched; RT-15 closed after fixing two real defects found via diagnostic re-testing — see Defect Log D-013/D-014.
**Tester:** WJ
...
| RT-09   | Final review, approval, and Word export               | Full  | Pass (caveat) | 2026-07-28 | ⚠️ Passed over a live defect — `GAP-41`/D-015, Word export discards all line breaks. New multi-line fidelity step added 2026-08-06; **re-run required once fixed**.        |
...
**Notes:** Live-tested 2026-07-28, no issues — **but that pass does not cover the new line-break fidelity step, and must not be read as if it does.** `GAP-41` (logged 2026-08-06 from a real user application) was live in the code on 2026-07-28 and this test passed straight over it, because the answers used were single paragraphs. The result stands for what it checked; **RT-09 needs re-running with a genuinely multi-line answer once `GAP-41` is fixed.** See Defect Log D-015.
