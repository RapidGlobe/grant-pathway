...
**Version:** 2.12
**Date:** 2026-06-15
**Last updated:** 2026-08-05 (RT-14 gains an optional Storage-deletion add-on for `GAP-47` — see Document History v2.12)
...
**What this tests:** The account deletion flow — confirmation gating, and that the account, profile, applications, and any in-flight guideline upload in Storage are actually removed.
...
**Optional add-on — Storage deletion (`GAP-47`, added 2026-08-05).** Steps 1–8 cannot observe the Storage half of deletion, because the bucket is empty by the time you get there: `/api/upload/process` deletes each object seconds after extracting its text. To exercise it deliberately, you have to catch a file mid-flight:
