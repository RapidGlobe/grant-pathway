...
**Version:** 2.18
**Date:** 2026-06-15
**Last updated:** 2026-08-19 (**D-020 has a second instance: a second migration recorded as applied on production whose statements never ran.** Found by the environment parity audit, repaired, and the re-run is clean. See Document History v2.18)
