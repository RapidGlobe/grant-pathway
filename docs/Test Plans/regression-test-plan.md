...
**Version:** 2.9
**Date:** 2026-06-15
**Last updated:** 2026-07-28 (RT-15 diagnostic found and fixed two real defects — modal dismiss-on-mouse-move, missing space in warning text)
**Status:** RT-00 through RT-14 all Pass (RT-03 and RT-11 with a caveat — plan text was stale, corrected; RT-14 confirms the 2026-07-23 `service_role` grant fix holds on `grant-pathway-dev`, `grant-pathway-prod` still unpatched). RT-15 is Investigating — a diagnostic shortened timer surfaced two real, previously-invisible defects (both fixed same day), and re-testing continues with that shortened timer still in place. See RT-15 notes and Defect Log D-013/D-014.
**Tester:** WJ
...
| RT-15   | Session timeout (inactivity)                          | Full  | Investigating | 2026-07-28 | Diagnostic (shortened timer) found and fixed two real defects (D-013 modal dismiss-on-mouse-move, D-014 missing space in warning text). Re-testing continues — see RT-15 notes. |
...
Both fixes are pushed. The shortened 1/2-minute timer is still in place for re-testing — will be reverted to 55/60 minutes once WJ confirms both fixes hold and the underlying sign-out logic (the original point of this re-test) is sound.
