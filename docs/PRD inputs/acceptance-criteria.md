...
| 9.2 Charity Profile                                          | FR-09 to FR-14, FR-12A | ✅ Reviewed 2026-07-13 — FR-10 corrected, FR-12A added, FR-09/FR-13 wording corrected. Updated 2026-07-15 — FR-12A re-sited from `/profile` to Step 4, then made guideline-driven per `PDR-AI-008` later the same day (all 3 ACs rewritten twice; see `ADR-DATA-006`'s two matching amendments)                                                                                                  |
