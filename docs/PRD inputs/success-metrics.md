...
*Targets to be reviewed at month 3 and revised for month 6 onward based on actual growth data.*
...
*The export completion rate is the single most important product metric — it confirms the full user journey is working end to end.*
...
*If FR-08 is not implemented in v1, this metric is deferred to the first phase in which feedback interviews are introduced.*
...
*No third-party analytics platform (e.g. Google Analytics) is included in v1 scope. All metrics are derived from existing Supabase data.*
