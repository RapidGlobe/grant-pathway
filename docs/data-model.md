...
| `rubric_criterion_link`  | UUID      | No       | Will reference a rubric table once P6.5 (Playbook Infrastructure) builds it. No FK constraint yet — the target table doesn't exist                                                                                                                                  |
