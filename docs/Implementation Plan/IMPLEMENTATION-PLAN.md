...
> **⏳ EXECUTED 2026-08-05 — 22 of 23 divergences dispositioned and applied. `P5.0` remains OPEN on one item.** Register: **`docs/Implementation Plan/pre-launch-reconciliation-2026-08-05.md`**. All four scoped work items were run. **This task closes when the last item is dispositioned, not when the register exists.**
>
> **The one thing still outstanding — R-06, and it needs a number from WJ.** `C1` states the monthly ceiling as **£100 covering infrastructure _and_ API**, but committed `P5.4` spend is Vercel Pro (~~£16) + Supabase Pro (~~£20) + a Bedrock ceiling of ≈£100 = **c. £136 before Upstash, Sentry, Resend or Axiom**. WJ decided 2026-08-05 to **keep C1 as a total and raise it to a realistic figure**; the figure itself is not yet set. Once it is, `C1`, `A3`, `A13`, `OBJ-05` and two PRD sections (§10's "total API spend" and §14's "AI API spend", which read the same £100 three different ways) all align to it and `P5.0` closes.
>
> **Decided and applied 2026-08-05 (WJ):**
>
> | Ref             | Decision                                                                                                                                                                                                                                                                                                                                                                                     |
> | --------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
...
> **✅ Drafted and published (updated 2026-07-16).** The Privacy Policy and Terms of Service were drafted during Phase 4 as originally required — both are live at `/privacy` and `/terms` (`app/(public)/privacy`, `app/(public)/terms`; content sources `docs/legal/privacy-policy.md` and `docs/legal/terms-of-service.md`). Two items remain open before launch, tracked in the table below: both documents currently show `Effective date: [TO BE CONFIRMED]` pending the actual go-live date, and neither has had the solicitor review this section originally called for (particularly the Privacy Policy, for UK GDPR compliance).
...
- **Confirm Privacy Policy and Terms of Service pages are live, linked in the footer, and no longer show `Effective date: [TO BE CONFIRMED]`** (strengthened 2026-07-30). Both pages are statically prerendered, so check the rendered text at `/terms` and `/privacy`, not just the source documents — and remember there are **four** files, the two internal copies and the two `-external.md` mirrors that the pages actually render. A published privacy policy with no effective date is not a defensible position for a registered data controller (ICO ZC168720). Setting the dates needs no solicitor; the independent review is tracked separately in P5.1.
