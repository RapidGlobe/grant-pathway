...
- **Axiom log management:** Create an Axiom account; select the EU region at signup to satisfy C13. In Vercel project settings → Log Drains, add the Axiom drain URL. No code changes required. This enables queryable, persistent log storage for all three AI routes, closing the AI route latency observability gap (GAP-27). See `docs/Technical Decision and Design/technology-stack-review-2026-06-30.md` for rationale.
