...
- [ ] **Phase 5 complete — stated explicitly (restated 2026-07-30).** This line previously read "P5.1–P5.5 complete", a range that silently omitted both tasks added by the Phase 5 restructure and gave no answer on `P5.5b`. The gate now requires, individually:
  ...
  - [ ] **P5.3b** — Spec-deviation fixes (GAP-22, GAP-21 remaining; GAP-23 may be deferred post-launch; GAP-24 built 2026-07-30, GAP-25 and GAP-31 built 2026-08-05)
