...
> **✅ Complete (updated 2026-08-09).** The Privacy Policy and Terms of Service were drafted during Phase 4 as originally required — both are live at `/privacy` and `/terms` (`app/(public)/privacy`, `app/(public)/terms`; content sources `docs/legal/privacy-policy.md` and `docs/legal/terms-of-service.md`). **Effective dates set 2026-08-05 — S2a closed** (privacy policy → v1.6, terms → v1.6 as of the same day's later sub-heading restructure, all four files including the two `-external.md` mirrors the routes actually render). **Independent solicitor review complete — S2b closed 2026-08-09.** Both documents came back with substantive changes — an indemnity clause and a new Section 15 (General) in the Terms; a complaints-acknowledgement paragraph and a widened international-transfer clause in the Privacy Policy, among others — incorporated as the "v1.6-final" text, dated 7 August 2026, without a version-number bump since the review corrected the existing v1.6 drafts rather than replacing them. Reviewer identity and fee not recorded in this pass. **`P5.1` is now complete.**
