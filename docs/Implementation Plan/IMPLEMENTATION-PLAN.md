...
**Estimated time:** 2 weeks for P5.1–P5.5. **Go-live itself (P5.6) is no longer targeted for 31 July 2026 — see the Phase 6 → Go-Live Gate below.** WJ decided 2026-07-05 that launch will not happen until Phase 6 (P6.1–P6.6) is complete; there is no commercial deadline forcing the original date. Working estimate: August–September 2026, not committed.
...
| Phase 6    | Application Item-Graph Rearchitecture — **now gates launch** (P6.1–P6.6; P6.7 ongoing, does not block) | Not estimated — see build plan | Capacity-dependent                                         |
