...
- [ ] **All Phase 6 dev-only migrations applied to `grant-pathway-prod`** (added 2026-07-16 — see P5.4's new migration-push task above): confirm via `supabase migration list` on both projects that every version is matched Local/Remote before DNS cutover
