...
> **✅ Drafted and published (updated 2026-07-16).** The Privacy Policy and Terms of Service were drafted during Phase 4 as originally required — both are live at `/privacy` and `/terms` (`app/(public)/privacy`, `app/(public)/terms`; content sources `docs/legal/privacy-policy.md` and `docs/legal/terms-of-service.md`). **Effective dates set 2026-08-05 — S2a closed** (privacy policy → v1.6, terms → v1.6 as of the same day's later sub-heading restructure, all four files including the two `-external.md` mirrors the routes actually render). **One item remains open: the solicitor review (S2b)**, which neither document has had — particularly the Privacy Policy, for UK GDPR compliance. `P5.1` closes when that review is done.
...
| Terms of Service          | ✅ **Drafted and published 2026-07-10** (`docs/legal/terms-of-service.md`, live at `/terms`). States: (1) does not guarantee funding, (2) does not submit applications, (3) makes no representations to funders. ✅ **Effective date set to 5 August 2026** (2026-08-05, → v1.5; restructured the same day to v1.6 — no-guarantee-of-funding statement given its own sub-heading in Section 5, ahead of solicitor review, wording unchanged). Dated from when the current text takes effect rather than from an unscheduled go-live, since the service is already live and in use by external testers. **Still open: solicitor review (S2b).**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                     | Item 45 |
| Privacy Policy            | ✅ **Drafted and published 2026-07-02** (`docs/legal/privacy-policy.md`, live at `/privacy`). Covers: data collected, Supabase London storage, Vercel edge network, Bedrock eu-west-2 with EU/EEA Geo fallback, no AI training commitment, user rights, retention period. ✅ **Effective date set to 5 August 2026** (2026-08-05, → v1.6). Dated from when the current text takes effect rather than from an unscheduled go-live. **Still open: solicitor review (S2b) — particularly for UK GDPR compliance.**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    | Item 46 |
...
- [ ] **Phase 5 complete — stated explicitly (restated 2026-07-30).** This line previously read "P5.1–P5.5 complete", a range that silently omitted both tasks added by the Phase 5 restructure and gave no answer on `P5.5b`. The gate now requires, individually:
  ...
  - [ ] **P5.1** — Compliance (includes the two legal effective dates, the independent review, and GAP-20's dependency licence review)
