...
| Terms of Service          | ✅ **Drafted and published 2026-07-10** (`docs/legal/terms-of-service.md`, live at `/terms`). States: (1) does not guarantee funding, (2) does not submit applications, (3) makes no representations to funders. ✅ **Effective date set to 5 August 2026** (2026-08-05, → v1.5). Dated from when the current text takes effect rather than from an unscheduled go-live, since the service is already live and in use by external testers. **Still open: solicitor review (S2b).**                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                 | Item 45 |
