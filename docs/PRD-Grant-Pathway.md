...
| Continue                      | Saves the selected funder and grant name to the existing application record (already created, empty, when `/applications/new` was visited -- see note below), advances to Step 2                                      |
...
_Document status: Version 0.31 Draft_
