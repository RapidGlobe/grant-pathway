    ...
    return (
      <div className="rounded-lg border border-[#E2E8F0] p-5">
        <p className="mb-4 text-[14px] text-[#374151]">
          ...
          then enter the 6-digit code shown in the app to complete setup.
        </p>

        {/* QR code — Supabase returns an SVG data URL */}
        <div className="mb-4 flex justify-center">
          {/* eslint-disable-next-line @next/next/no-img-element */}
          <img src={qrCode} alt="QR code for your authenticator app" className="h-40 w-40" />
        </div>
        ...
        <form action={verifyAction}>
          ...
          >
            {isVerifyPending ? 'Activating…' : 'Activate two-factor authentication'}
          </Button>
        </form>
      </div>
    )
  ...
  return (
    <>
      ...
      <form action={unenrollAction}>
        ...
        >
          {isUnenrollPending ? 'Removing…' : 'Remove two-factor authentication'}
        </button>
      </form>
    </>
  )
