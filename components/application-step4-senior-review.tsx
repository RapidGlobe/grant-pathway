    ...
    <div className="mx-auto w-full max-w-[640px] px-4 py-10 sm:px-0">
      ...
      <div className="mb-6 rounded-xl border border-[#E2E8F0] bg-white p-6">
        <p className="mb-4 text-[15px] text-[#374151]">
          Your answers have been saved. Before your draft is assembled, please
          confirm that a senior colleague — such as your CEO, treasurer, or a
          trustee — has reviewed your budget answers.
        </p>
        <p className="text-[14px] text-[#64748B]">
          Funders verify financial information. Inaccurate budget answers are
          one of the most common reasons grant applications are unsuccessful or
          withdrawn. Once assembled, you will be able to review and approve the
          full draft before it is exported.
        </p>
      </div>
