...
export function AccountSettingsForm({ email }: AccountSettingsFormProps) {
  ...
  return (
    <div className="mx-auto w-full max-w-[640px] px-4 py-10 sm:px-0">
      <h1 className="mb-8 text-[1.5rem] font-bold text-[#1E293B]">Account settings</h1>

      {/* ── Email address ──────────────────────────────────────────────────── */}
      <section aria-labelledby="email-heading" className="mb-8">
        <h2 id="email-heading" className="mb-4 text-[1rem] font-semibold text-[#1E293B]">
          Email address
        </h2>
      ...
      <section aria-labelledby="password-heading" className="mb-8">
        <h2 id="password-heading" className="mb-4 text-[1rem] font-semibold text-[#1E293B]">
        ...
        {passwordUpdated && (
          ...
          >
            ...
            <p className="text-[0.875rem] text-[#166534]">Your password has been updated.</p>
          </div>
        )}
        ...
        <form noValidate onSubmit={handlePasswordSubmit}>
          ...
          <div className="mb-4">
            ...
            {fieldErrors.newPassword ? (
              ...
              <p id="newPassword-hint" className="mt-1.5 text-[0.8125rem] text-[#64748B]">
          ...
          <Button
            type="submit"
            disabled={isPending}
            className="h-10 bg-[#0D6E6E] px-5 text-[0.875rem] font-semibold text-white hover:bg-[#0A5A5A] disabled:opacity-60"
          >
      ...
      <section aria-labelledby="delete-heading">
        <h2 id="delete-heading" className="mb-2 text-[1rem] font-semibold text-[#1E293B]">
          Delete your account
        </h2>
        <p className="mb-5 text-[0.875rem] text-[#374151]">
        ...
        <ContextualTooltip content="This permanently deletes your charity profile and all saved applications. This can't be undone.">
          <Button
            ...
            className="h-10 bg-[#DC2626] px-5 text-[0.875rem] font-semibold text-white hover:bg-[#B91C1C]"
          >
            Delete my account
          </Button>
        </ContextualTooltip>
